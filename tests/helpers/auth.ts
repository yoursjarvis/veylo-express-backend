...
let mockSessionValue: any = {
  user: { id: "user-123", email: "user@example.com", firstName: "Test", lastName: "User" },
  session: { id: "session-123", activeOrganizationId: "org-123", token: "mock-token" },
};

/**
 * Dynamic Mock Implementation for Better Auth getSession
 */
export const getSessionMock = vi.fn().mockImplementation((options?: { returnHeaders?: boolean }) => {
