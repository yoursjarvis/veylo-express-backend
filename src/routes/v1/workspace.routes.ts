...
workspaceRoutes.get(
  "\/",
  requireAuth,
  requirePermission("workspace:read", extractContext),
  requirePermission("workspace:read", extractContext),
...
workspaceRoutes.post(
  "\/",
  requireAuth,
  requirePermission("workspace:create", extractContext),
  requirePermission("workspace:create", extractContext),
...
workspaceRoutes.patch(
  "\/:id",
  requireAuth,
  requirePermission("workspace:update", extractContext),
  requirePermission("workspace:update", extractContext),
...
workspaceRoutes.delete(
  "\/:id",
  requireAuth,
  requirePermission("workspace:delete", extractContext),
...
workspaceRoutes.post(
  "\/:id\/restore",
  requireAuth,
  requirePermission("workspace:restore", extractContext),
...
workspaceRoutes.delete(
  "\/:id\/force",
  requireAuth,
  requirePermission("workspace:force-delete", extractContext),
...
workspaceRoutes.post(
  "\/:id\/members",
  requireAuth,
  requirePermission("workspace:invite-members", extractContext),
...
workspaceRoutes.delete(
  "\/:id\/members\/:userId",
  requireAuth,
  requirePermission("workspace:remove-members", extractContext),
...
workspaceRoutes.get("/:id/kpi/stats", requireAuth, kpiController.getUserStats);
