...
docRoutes.post("\/projects\/:projectId\/docs", requireAuth, requirePermission("project-doc:create", extractContext), requirePermission("project-doc:create", extractContext), docController.createDoc);
docRoutes.get("\/projects\/:projectId\/docs", requireAuth, requirePermission("project-doc:view", extractContext), requirePermission("project-doc:view", extractContext), docController.getProjectDocs);
...
docRoutes.get("\/docs\/:id", requireAuth, requirePermission("project-doc:view", extractContext), requirePermission("project-doc:view", extractContext), docController.getDoc);
docRoutes.patch("\/docs\/:id", requireAuth, requirePermission("project-doc:edit", extractContext), requirePermission("project-doc:edit", extractContext), docController.updateDoc);
docRoutes.delete("\/docs\/:id", requireAuth, requirePermission("project-doc:delete", extractContext), requirePermission("project-doc:delete", extractContext), docController.deleteDoc);
docRoutes.post("\/docs\/:id\/restore", requireAuth, requirePermission("project-doc:restore", extractContext), requirePermission("project-doc:restore", extractContext), docController.restoreDoc);
