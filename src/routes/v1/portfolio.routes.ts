...
portfolioRoutes.get(
  ...
  requireAuth,
  requirePermission("portfolio:read", extractContext),
...
portfolioRoutes.post(
  "\/workspaces\/:workspaceId\/portfolios",
  requireAuth,
  requirePermission("portfolio:create", extractContext),
...
portfolioRoutes.patch(
  "\/portfolios\/:id",
  requireAuth,
  requirePermission("portfolio:update", extractContext),
...
portfolioRoutes.delete(
  "\/portfolios\/:id",
  requireAuth,
  requirePermission("portfolio:delete", extractContext),
...
portfolioRoutes.post(
  ...
  requireAuth,
  requirePermission("portfolio:restore", extractContext),
...
portfolioRoutes.delete(
  "\/portfolios\/:id\/force",
  requireAuth,
  requirePermission("portfolio:force-delete", extractContext),
